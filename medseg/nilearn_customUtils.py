...
#NOTE: This has been modified from its original (from nilearn) to be able to return the slices if desired.
def crop_img(img, rtol=1e-8, copy=True, return_slices=False):
    ...
    if return_slices: #This line has been added!!
        return slices #This line has been added!!
